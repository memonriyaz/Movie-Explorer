...
export const LoginForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res?.error) {
        // Map internal errors to user-friendly ones
      ...
      <div className="max-w-sm w-full space-y-6">
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            >
              <span className="absolute left-0 inset-y-0 flex items-center pl-3 hover:text-blue-400">
                {isLoading ? (
                  <Loader2 className="h-5 w-5 text-blue-500 animate-spin" />
                ) : (
                  <LogIn className="h-5 w-5  group-hover:text-blue-400" />
                )}
              </span>
              {isLoading ? (
                "Signing in..."
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full inline-flex justify-center py-3 px-4 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-black text-sm font-medium text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors"
              >
